...
function Login() {
    ...
    // submit button control while after form submission
                    ...
                    <div className='h-[75vh] md:h-[85vh] md:w-1/2 flex justify-center items-center '>
                        <div className='flex flex-col items-center gap-5 md:gap-6'>
                            ...
                            <form action="" onSubmit={handleSubmit} className='flex flex-col justify-center items-center md:justify-center md:items-center gap-4 w-60'>
                                ...
                                <button type='submit' disabled={isSubmit} className='custom-background hover:bg-blue-600 md:w-80 text-sm md:text-md hover:cursor-pointer w-[16rem] text-white p-2.5 rounded '>
                                    {
                                ...
                                {/* Desktop view */}
                                <p className='hidden md:block text-md md:text-md text-[#7257ff] my-2 hover:cursor-pointer'>
