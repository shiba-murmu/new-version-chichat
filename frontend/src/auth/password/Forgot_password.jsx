...
function Forgot_password() {
    ...
    const Otp_verify = () => {
        return (
            <>
                <div className='flex absolute z-20 left-0 right-0 items-center justify-end flex-col h-[60vh]'>
                    <div className='flex flex-col gap-2 items-center justify-center w-[90%] rounded-lg bg-[#7257ff] h-80'>
                        ...
                        <div className='w-[80%]'>
                            <button type='submit' className='w-full hover:cursor-pointer bg-[#fcfcfc] text-[#7257ff]  py-2 rounded-md'>                            Recovery password
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div>
                <form action="" onSubmit={handleSubmit} className='flex flex-col gap-2'>
                    <div className='my-2 px-2'>
                        <label htmlFor="email" className='text-md'>Enter registered email address</label>
                    </div>
                    <div className='px-2'>
                        <input type="email" id='email' onChange={handleChange} value={formData.email} name='email' required className='input-style border border-[#7257ff] rounded-md
                        px-3 py-2 w-full focus:outline-[#7257ff]' placeholder='Email address' />
                    </div>
                    <div className='my-2 px-2'>
                        <label htmlFor="password" className='text-md'>Enter new password!</label>
                    </div>
                    <div className=' relative w-full px-2'>
                        <input type={isEyeOpenedPassword ? 'text' : 'password'} id='password' onChange={handleChange} value={formData.password} name='password' required className='input-style border border-[#7257ff] rounded-md
                    ...
                    <div className=' relative w-full px-2'>
                        <input type={`${isEyeOpenedConfirmPassword ? 'text' : 'password'}`} id='confirm-password' name='confirm_password' onChange={handleChange} value={formData.confirm_password} required className='input-style border border-[#7257ff] rounded-md
                    ...
                    <div className='px-2 my-2'>
                        <button type='submit' className='w-full hover:cursor-pointer bg-[#7257ff] text-white py-2 rounded-md'>
