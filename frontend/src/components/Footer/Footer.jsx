...
function Footer() {
    return (
        <div className='fixed bottom-0 left-0 md:left-80 right-0'>
            <div className='flex justify-around md:justify-around mx-5 md:w-[50vw] rounded-t-4xl shadow-md shadow-gray-400 items-center py-5 md:p-5 bg-[#e0dfe4] border-t border-gray-100'>
                <section>
                    {/* For home */}
                    <Link to={'/home'}>
