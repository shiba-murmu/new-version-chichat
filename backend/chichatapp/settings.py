"""
Django settings for chichatapp project.
...
SECRET_KEY = config('django-insecure-o^3i)*3q19-#(j+lmn7hm)0wz_3)h#ie*(*k1&b9s(y7aj%$8u')
...
SIMPLE_JWT = {
    ...
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10), # increased to 10min
...
WSGI_APPLICATION = 'chichatapp.wsgi.application'
